...
class AboutClassMethods < Neo::Koan
  ...
  #
  # I prefer the self. way because reading it is more explicit. However, I can see use cases for using the << self way.
  # If you were going to have a ton of methods at the class level writing self. each time could become tedious.
