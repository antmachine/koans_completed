...
class AboutSymbols < Neo::Koan
  ...
  # Comparing strings allows content to be compared rather than object_ids. Two symbols could point to the same object_id.
  ...
  # Spaces, readability, etc. can become a pain very quickly.
end
