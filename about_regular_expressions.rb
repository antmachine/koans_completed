...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # It will fail when there is something before or after that doesn't match.
    # Such as ab*c will fail to match azc, since b* will not match z and c.
  end
  ...
  # Alternation will search to the right or left of the pipe, character class will search for the first matching character.
